    ...
    return (
        ...
        <div className="flex flex-col items-center justify-between pt-12 md:flex-row">
            <div className=" mt-8 space-y-2 w-1/2">
                ...
                <button className="bg-red-800 text-xl text-white font-semibold rounded-md mt-4 py-2 w-48 text-center">Скачать</button>
            </div>
            <div className="mt-8 w-1/2">
                <div className="">
                    <img src={image} className='p-8' alt="mobile image"/>
                </div>
            </div>
        </div>
        </div>
